...
{
    public class EnumTextBlock : TextBlock
    {
        ...
        public static readonly DependencyProperty EnumNameProperty =
            DependencyProperty.Register("EnumName", typeof(string), typeof(EnumTextBlock), new PropertyMetadata((d, e) =>
            {
                ...
                if (!string.IsNullOrWhiteSpace(enumTextBlock.EnumName))
                    foreach (var item in Enums.EnumHelper.GetEnum(enumTextBlock.EnumName))
                        enumTextBlock.enumDictionary.Add(item.Value, item.DisplayName);
        ...
        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value", typeof(sbyte), typeof(EnumTextBlock), new PropertyMetadata((d, e) => ((EnumTextBlock)d).RefreshValue()));
    }
}
